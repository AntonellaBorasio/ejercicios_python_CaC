''' Actividad Práctica 3 de Python

1) Crear la clase Persona con el los métodos “print_persona”. Luego crear dos objetos del tipo Persona e imprimirlos por consola.
...
'''
2) al ejercicio anterior crear el metodo  __str__() que retorna un String con los datos de los atributos, desde el programa principal imprimir el objeto de la clase y ver que esta ejecutando el metodo __str__(),
...
5) A la clase persona agregarle un método estático “get_mayor” que reciba dos objetos Persona y devuelva el de edad mayor.
